...
É a compoñente máis importante do ordenador. Hai quen di que é o verdadeiro  cerebro  xa que controla e goberna todo o sistema.
 ...
 A CPU (central processing unit) como adoita chamarse consiste nun circuito integrado que interpreta e executa as instrucións dos programas almacenados na [memoria, ]({{site.url}}/montaxe/09RAM)  toma os datos dun [periférico de entrada,]({{site.url}}/montaxe/20I-O) procésaos  e envíaos a un [periférico de saída.]({{site.url}}/montaxe/20I-O)

Esta formado por:

> -[unidade de control (UC)]({{site.url}}/montaxe/04UC)

> -[unidade aritmético-lóxica (ALU)]({{site.url}}/montaxe/04ALU)

> -[memorias caché]({{site.url}}/montaxe/08cache)
